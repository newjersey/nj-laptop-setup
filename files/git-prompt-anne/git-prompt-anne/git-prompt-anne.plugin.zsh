...
ZSH_THEME_GIT_PROMPT_PREFIX="%{$FG[186]%}|"
ZSH_THEME_GIT_PROMPT_SUFFIX="%{$FG[186]%}|"
ZSH_THEME_GIT_PROMPT_SEPARATOR=""
ZSH_THEME_GIT_PROMPT_BRANCH="%{%B$FG[186]%}"
ZSH_THEME_GIT_PROMPT_STAGED="%{$FG[186]%}%{S:%G%}"
ZSH_THEME_GIT_PROMPT_CONFLICTS="%{$fg[red]%}%{✖%G%}"
ZSH_THEME_GIT_PROMPT_CHANGED="%{$FG[186]%}%{U:%G%}"
ZSH_THEME_GIT_PROMPT_DELETED="%{$FG[186]%}%{-%G%}"
ZSH_THEME_GIT_PROMPT_BEHIND="%{$FG[186]%}%{↓%G%}"
ZSH_THEME_GIT_PROMPT_AHEAD="%{$FG[186]%}%{↑%G%}"
ZSH_THEME_GIT_PROMPT_UNTRACKED="%{$FG[186]%}%{?:%G%}"
ZSH_THEME_GIT_PROMPT_STASHED="%{$fg_bold[blue]%}%{⚑%G%}"
ZSH_THEME_GIT_PROMPT_CLEAN="%{%B$FG[186]%}%{✔%G%}"
ZSH_THEME_GIT_PROMPT_UPSTREAM_SEPARATOR="->"

# Set the prompt.
GIT_PROMPT_ANNE='$(git_super_status)'
